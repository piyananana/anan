class ApVendorRunning {
  ...
  factory ApVendorRunning.fromJson(Map<String, dynamic> json) => ApVendorRunning(
        id: json['id'],
        isAutoNumbering: json['is_auto_numbering'] ?? false,
        formatPrefix: json['format_prefix'] ?? 'VEND',
