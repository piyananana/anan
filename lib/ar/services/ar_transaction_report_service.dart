...
class ArTransactionReportService {
  ...
  Future<List<Map<String, dynamic>>> getTransactionReport({
    ...
    String sortBy = 'customer', // 'customer' | 'doc_type'
  }) async {
    ...
    final uri = Uri.parse('$baseUrl/ar_transaction_report')
    ...
    throw Exception('Failed to load AR transaction report: ${response.body}');
  }
}
