...
class ArCustomerRunningScreen extends StatefulWidget {
  const ArCustomerRunningScreen({super.key});

  @override
  State<ArCustomerRunningScreen> createState() =>
      _ArCustomerRunningScreenState();
}

class _ArCustomerRunningScreenState extends State<ArCustomerRunningScreen> {
  late ArCustomerRunningService _service;

  ArCustomerRunning? _config;
  ...
  void initState() {
    super.initState();
    _service = Provider.of<ArCustomerRunningService>(context, listen: false);
    _loadConfig();
  }
  ...
  void _applyConfig(ArCustomerRunning config) {
