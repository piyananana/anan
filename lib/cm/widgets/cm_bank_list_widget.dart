...
class BankListWidgetState extends State<BankListWidget>
  ...
  List<Bank> get _filtered {
    ...
    switch (_sortBy) {
      ...
      case 'name_asc': items.sort((a, b) => a.bankNameThai.compareTo(b.bankNameThai)); break;
      case 'name_desc': items.sort((a, b) => b.bankNameThai.compareTo(a.bankNameThai)); break;
    }
    return items;
  }
                        ...
                        return Card(
                          ...
                          ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                if ((item.bankNameEng ?? '').isNotEmpty)
